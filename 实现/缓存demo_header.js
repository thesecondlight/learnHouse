...
app.get('/demo.js', (req, res) => {
    ...
    res.setHeader('ETag', etag); //实体标签的当前值

    res.writeHead(200, 'OK')

    res.setHeader("Content-Type", "text/html")
    res.setHeader("Set-Cookie", ["type=ordinary"])
    // https://blog.csdn.net/weixin_41723305/article/details/109556915
    // 缓存优先级
    // Cache-Control > Expires > ETag > Last-Modified 


    // request responses Header响应头
    /**
